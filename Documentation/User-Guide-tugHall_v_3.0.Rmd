...
```{r, echo=FALSE, results='asis'}
x <- read.csv(file = "../Output/log.txt",header = FALSE, sep = "\t", col.names = c("Variable","Value"), stringsAsFactors = FALSE )
x[is.na(x)] <- ""
x[ c(6,7) , 1 ] =  c( 'E0' , 'F0' )
...
25. **passenger_genes** - the binary numbers indicate the passenger mutation at the gene related to order of genes in onco as well as order of the next columns with genes' names, e.g., '0 0 1 0' means that the third gene has a passanger mutation and other genes have no.
